          ...
          <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@spectracommunity.com</p>
                    <p className="text-gray-600">support@spectracommunity.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex gap-4">
                ...
                <a href="#" className="w-12 h-12 bg-blue-400 rounded-lg flex items-center justify-center text-white hover:bg-blue-500 transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-12 h-12 bg-blue-700 rounded-lg flex items-center justify-center text-white hover:bg-blue-800 transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
